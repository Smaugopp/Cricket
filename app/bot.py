...
async def run():
    ...
    # Register command/callback routers before the numeric game router. The game
    # router only handles 1–6, but keeping it last makes command routing
    # unambiguous and prevents future catch-all additions from swallowing
    # /team, /stats, /leaderboard, etc.
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="mystats", description="Your career stats"),
        ...
        BotCommand(command="botstats", description="Owner bot dashboard"),
