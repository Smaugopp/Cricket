...
async def run():
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command="play", description="Create a 1v1 match"),
        BotCommand(command="join", description="Join a 1v1 lobby"),
        BotCommand(command="solo", description="Play against AI"),
        BotCommand(command="custom", description="Custom overs and balls"),
